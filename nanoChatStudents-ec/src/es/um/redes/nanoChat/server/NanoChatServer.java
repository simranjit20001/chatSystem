...
public class NanoChatServer implements Runnable {
	...
	private static final int MYPROTOCOL = 127;
	...
	private NanoChatServer(InetSocketAddress a) {
		...
		List<String> defaultRooms = Arrays.asList("Global", "España", "Alemania", "Italia");
		List<String> reservedNames = Arrays.asList("System", "admin", "root");
		manager = new NCServerManager(defaultRooms, reservedNames);
